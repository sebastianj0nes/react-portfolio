        ...
        <Container>
            <Col>
                <Row>
                    ...
                    <p className="d-flex justify-content-center align-items-center">Enjoy creative processes, exploring new topics & pushing boundaries</p>
                    <h5 className="d-flex justify-content-center align-items-center p-3">Key interests in :</h5>
                    <p className="d-flex justify-content-center align-items-center p-3">Blockchain Technology, AI & AGI and Machine Learning  </p>
                </Row>
                <Row>
